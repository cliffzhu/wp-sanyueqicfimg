...
add_action( 'wp_ajax_wpsanyueimg_check_update_popup', 'wpsanyueimg_ajax_check_update_popup' );
add_action( 'wp_ajax_wpsanyueimg_apply_update', 'wpsanyueimg_ajax_apply_update' );
